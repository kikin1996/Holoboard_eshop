...
-- CreateEnum
CREATE TYPE "ShippingMethod" AS ENUM ('PACKETA_ZBOX', 'PACKETA_HOME', 'COURIER');

-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('WAITING', 'PAID', 'CANCELLED', 'REFUNDED');
...
CREATE TABLE "Order" (
    ...
    "packetaBranchId" TEXT,
    "packetaBranchName" TEXT,
    "paymentProvider" TEXT NOT NULL DEFAULT 'comgate',
